...
We assume all cases/carriersare observed which is to say they have an age-of-onset that precedes the censoring age. This assumption is relaxed in *Partially Observed Case-Control Status*.
