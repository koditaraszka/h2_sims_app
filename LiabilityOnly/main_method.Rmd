...
# Returns: case-control status, age, liabiliity, genetic liability, GRM,  genetic liability deciles
...
liab = function(N, M, h2, C, ageDist, minOnset, maxOnset, cenRate, info){
